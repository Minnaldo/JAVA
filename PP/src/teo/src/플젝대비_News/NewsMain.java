...
public class NewsMain {
	...
	public static void main(String[] args) {
		/*
		NewsDAODOMImpl newDom = new NewsDAODOMImpl();
		NewsDAOSAXImpl newSax = new NewsDAOSAXImpl();
		ArrayList<News> list = newSax.getNewsList("http://rss.etnews.com/Section902.xml");
        for(News news: list)
